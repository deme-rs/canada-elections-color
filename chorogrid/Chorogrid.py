...
class Chorogrid(object):
    """ An object which makes choropleth grids, instantiated with:
            dataframe: a df with the following columns:
            ...
            id_column: the name of the column in dataframe containing ids
    ...
    """
    def __init__(self, dataframe, ids, colors, id_column='abbrev'):
        self.df = dataframe
    ...
    def draw_squares(self, x_column='square_x', 
        ...
        the specified columns in dataframe specified when Chorogrid class
        initialized.
        ...
        for i, id_ in enumerate(self.df[self.id_column]):
            ...
            _ = ET.SubElement(self.svg, 
                              "foreignObject", 
                              width=str(spacing_dict['cell_width']-2),
                              height=str(spacing_dict['cell_width']-3), 
                              id="text{}".format(id_),
                              x=str(x + 2),
    ...
    def draw_map(self, path_column='map_path', **kwargs):
        """ Creates an SVG file based on SVG paths delineating a map, 
            with paths from the specified columns in dataframe 
    ...
    def draw_hex(self, x_column='hex_x', y_column='hex_y', true_rows=True, **kwargs):
        ...
        from the specified columns in dataframe specified when Chorogrid class
        initialized.
